...
<template>
  <LayoutAuthenticated>
    <SectionMain>
      ...
      <CardBox class="md:w-7/12 lg:w-5/12 xl:w-4/12 shadow-2xl md:mx-auto" is-form is-hoverable
        ...
        <FormField label="Name">
          <FormControl v-model="form.name" :icon-left="mdiAccount" help="Game name" placeholder="Game name" required />
        </FormField>

        <FormField label="Price">
          <FormControl v-model="form.price" :icon-left="mdiAccount" help="Game Price" placeholder="Price" required />
        </FormField>
    ...
    <datatablecomponent :games="gamesEdit" :form="form" :columns="columns" ></datatablecomponent>
