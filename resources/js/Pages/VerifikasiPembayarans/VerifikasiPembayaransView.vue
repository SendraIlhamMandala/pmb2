...
var props = defineProps(["users", "tahun"]);
...
const columns = [
    ...
    { data: "created_at", render: data => new Date(data).getFullYear() },
    {
        ...
        render: function (data, type, row) {
            ...
            return (
                "<a class='table-edit' data-id='" + row.id + "' href='/users/" + row.id + "/edit' >EDIT</a>"
            );
        },
    },
    {
        ...
        render: function (data, type, row) {
            ...
            return (
                "<a class='table-edit' href='users/delete/" + row.id + "'' method='delete' ) >HAPUS</a>"
            );
        },
    },
];
...
console.log(props.users, props.tahun);
    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            ...
            <CardBox class="mt-6">
                ...
                <datatablecomponent :buttons_data="buttons_data" routeTo="users"  :dataFrom="users" :form="form" :columns="columns">
                </datatablecomponent>
            </CardBox>
        </SectionMain>
    </LayoutAuthenticated>
